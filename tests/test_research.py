...
def test_tool_descriptions_steer_search_first_and_research_for_hard_questions(client, provider):
    ...
    assert list(tools) == ["Skill", "get_my_profile", "list_products", "get_pricing", "search_knowledge", "research", "request_handoff", "ask_customer", "capture_lead", "remember", "read_attachment"]
